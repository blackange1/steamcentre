"""
Django settings for steamcentre project.
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            BASE_DIR / 'templates',
            BASE_DIR.joinpath('templates').joinpath('allauth'),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'steamcentre.wsgi.application'
